...
def run_main():
  ...
  parser.add_argument(
      "--input_graph",
      type=str,
      default="./ckpt/MobileFaceNet_epoch_0_iter_4.ckpt.meta",
  ...
  parser.add_argument(
      "--input_checkpoint",
      type=str,
      default="output/ckpt/MobileFaceNet_epoch_0_iter_4.ckpt.data-00000-of-00001",
