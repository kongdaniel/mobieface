...
def get_parser():
    ...
    parser.add_argument('--max_epoch', default=4, help='epoch to train the network')#20
    ...
    parser.add_argument('--train_batch_size', default=10, help='batch size to train network')#200
    parser.add_argument('--test_batch_size', type=int,
                        help='Number of images to process in a batch in the test set.', default=2)#Originaly：100
    ...
    parser.add_argument('--saver_maxkeep', default=6, help='tf.train.Saver max keep ckpt files')
    parser.add_argument('--buffer_size', default=10000, help='tf dataset api buffer size')
    parser.add_argument('--summary_interval', default=2, help='interval to save summary')#400
    parser.add_argument('--ckpt_interval', default=20, help='intervals to save ckpt file')#2000
    parser.add_argument('--validate_interval', default=2, help='intervals to save ckpt file')#2000
    parser.add_argument('--show_info_interval', default=1, help='intervals to save ckpt file')#20
