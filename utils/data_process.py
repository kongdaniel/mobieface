...
def create_tfrecords():
    ...
    print('id2range', len(id2range))#输出分类数量，即图片提供者的个数
...
def load_data(db_name, image_size, args):
    # python3
    bins, issame_list = pickle.load(open(os.path.join(args.eval_db_path, db_name+'.bin'), 'rb'), encoding='bytes',errors='ignore')
    issame_list=issame_list[0:30]
    # python2
